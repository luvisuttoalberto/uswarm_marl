...
directory = './data_benchmark_swarm/visibility_%.2f_gamma_%.4f_eps_%.1f_reset_%s_correct/' % (visibility_pipe, gamma, epsilon_0, reset_type)
...
directory = './data_benchmark_neigh/visibility_%.2f_gamma_%.4f_eps_%.1f_reset_%s/' % (visibility_pipe, gamma, epsilon_0, reset_type)
...
# ax1.plot(range(len(visited_sections_4))[-moving_average_sections_4.size:], moving_average_sections_4, label="without neighbors")
# ax1.plot(range(len(visited_sections_8))[-moving_average_sections_8.size:], moving_average_sections_8, label="without neighbors")
...
# ax1.plot(range(len(nn_visited_sections_4))[-nn_moving_average_sections_4.size:], nn_moving_average_sections_4, label="with neighbors")
# ax1.plot(range(len(nn_visited_sections_8))[-nn_moving_average_sections_8.size:], nn_moving_average_sections_8, label="with neighbors")
...
# ax1.plot(range(len(average_visited_sections_4))[-moving_average_average_sections_4.size:], moving_average_average_sections_4, label="without neighbors")
ax1.plot(range(len(average_visited_sections_8))[-moving_average_average_sections_8.size:], moving_average_average_sections_8, label="without neighbors")
...
# ax1.plot(range(len(nn_average_visited_sections_4))[-nn_moving_average_average_sections_4.size:], nn_moving_average_average_sections_4, label="with neighbors")
ax1.plot(range(len(nn_average_visited_sections_8))[-nn_moving_average_average_sections_8.size:], nn_moving_average_average_sections_8, label="with neighbors")
