...
# ax1.plot(range(len(visited_sections_16))[-moving_average_sections_16.size:], moving_average_sections_16, label="without neighbors", color = "C2")
...
# ax1.plot(range(len(nn_visited_sections_16))[-nn_moving_average_sections_16.size:], nn_moving_average_sections_16, label="with neighbors", color = "C2", linestyle = "--")
...
# ax1.plot(range(len(average_visited_sections_16))[-moving_average_average_sections_16.size:], moving_average_average_sections_16, label="without neighbors", color = "C2")
...
# ax1.plot(range(len(nn_average_visited_sections_16))[-nn_moving_average_average_sections_16.size:], nn_moving_average_average_sections_16, label="with neighbors", color = "C2", linestyle = "--")
